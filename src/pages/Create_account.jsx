...
const AuthPage = () => {
  ...
  return (
    ...
    <div className="flex justify-center items-center md:w-2/5 mt-14 my-auto md:mx-auto ">
      ...
      {isLogin ? (
        <div className="login-form ">
          ...
          <form className="pt-4">
            ...
            <button className="py-1 px-6 text-lg "  type="submit">Login</button>
            </div>
          </form>
          <p className="pt-3">
        ...
        <div className="signup-form">
         ...
         <p className="">Please sign up to book appointment</p>
          <form className="pt-4">
            ...
            <div className="flex justify-center rounded items-center active">
            <button className="py-1 px-6 text-lg "  type="submit">Sign up</button>
            </div>
          </form>
          <p className="pt-3">
