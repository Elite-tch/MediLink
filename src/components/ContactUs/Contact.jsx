...
export default function Contact() {
  return (
    <div className='pt-[23%] md:pt-[8%]'>
      ...
      <h1 className='font-bold text-gray-600 text-center text-3xl  md:pb-6'>CONTACT <span className='text-gray-950'>US</span></h1>
...
<form className=" md:w-2/5 w-full">
            ...
            <button className="py-1 px-4 text-lg "  type="submit">Send message</button>
            </div>
          </form>
