...
booking:'Booking slots ',
 ...
 { id: 17, src:'/bg5.png' ,  name: 'Dr. Emily Larso ', skill:'MBBS - Gastroenterologist ',icon:'/verify.png ', text:'Dr. Davis has a strong commitment to delivering comprehensive medical care, focusing on preventive medicine, early diagnosis and  effective treatment strategies. Dr. Davis has a strong commitment to delivering comprehensive  medical care focusing on preventive medicine, early diagnosis, and effective treatment strategies ',
  year:'4 Years ', about:'About ', icon2:faCircleExclamation , appoint:'Appointment ', amount:'$63 ',
booking:'Booking slots ',
day1:'TUE ', week1:'24 ', day2:'WED ', week2:'23 ', day3:'THU ', week3:'24 ',
day4:'FRI ', week4:'25 ', day5:'SAT ', week5:'26 ', day6:'MON', week6:'27 ',
...
<div>
<img src={doctor.src} className='bg-[#C6EFE5] shadow-2xl rounded-md' />
</div>
...
<button  onClick={() => navigate("/booking")} className='text-lg bg-[#0EBE7F] text-white py-3 my-7 px-6 rounded-full' type="button">{doctor.button}</button>
